...
public class BackupRestoreService {
    ...
    public ResponseEntity<byte[]> backupDatabase() {
        try {
            String backupFilePath = "D:/backup.sql"; // Đường dẫn tệp sao lưu
            String command = "C:/xampp/mysql/bin/mysqldump -u root hotrohoctap2";
...
//            tempFile = new File("F:\\Baocao\\backup2.sql");
            tempFile = new File("D:\\backup2.sql");

            File backupDirectory = new File("F:\\");
