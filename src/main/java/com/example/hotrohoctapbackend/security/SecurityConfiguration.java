    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        config -> config
                                ...
                                .requestMatchers(HttpMethod.GET, Endpoint.USER_GET_ENDPOINT).hasAnyAuthority("USER", "HUITSTUDENT")
                                .requestMatchers(HttpMethod.POST, Endpoint.USER_POST_ENDPOINT).hasAnyAuthority("USER", "HUITSTUDENT")
                                .requestMatchers(HttpMethod.PUT, Endpoint.USER_PUT_ENDPOINT).hasAnyAuthority("USER", "HUITSTUDENT")
                                .requestMatchers(HttpMethod.DELETE, Endpoint.USER_DELETE_ENDPOINT).hasAnyAuthority("USER", "HUITSTUDENT")

//                                .requestMatchers(HttpMethod.GET, Endpoint.TEACHER_GET_ENDPOINT).hasAnyAuthority("TEACHER", "ADMIN")
//                                .requestMatchers(HttpMethod.POST, Endpoint.TEACHER_POST_ENDPOINT).hasAnyAuthority("TEACHER", "ADMIN")
//                                .requestMatchers(HttpMethod.PUT, Endpoint.TEACHER_PUT_ENDPOINT).hasAnyAuthority("TEACHER", "ADMIN")
//                                .requestMatchers(HttpMethod.DELETE, Endpoint.TEACHER_DELETE_ENDPOINT).hasAnyAuthority("TEACHER", "ADMIN")

                                .requestMatchers(HttpMethod.GET, Endpoint.HUIT_STUDENT_GET_ENDPOINT).hasAuthority("HUITSTUDENT")
                                .requestMatchers(HttpMethod.POST, Endpoint.HUIT_STUDENT_POST_ENDPOINT).hasAnyAuthority("HUITSTUDENT", "ADMIN", "TEACHER")

                                .requestMatchers(HttpMethod.GET, Endpoint.USER_GET_ENDPOINT).hasAuthority("USERVIP")
                                .requestMatchers(HttpMethod.POST, Endpoint.USER_POST_ENDPOINT).hasAuthority("USERVIP")
                                .requestMatchers(HttpMethod.PUT, Endpoint.USER_PUT_ENDPOINT).hasAuthority("USERVIP")
                                .requestMatchers(HttpMethod.DELETE, Endpoint.USER_DELETE_ENDPOINT).hasAuthority("USERVIP")
