...
//    public GeneralDocument uploadFile(MultipartFile file, String title, String description, int idCategory) throws IOException, ExecutionException, InterruptedException {
...
//
//        Path convertedFilePath = Files.createTempFile("converted", ".pdf");
//
...
//            // Convert DOCX to PDF
//            convertDocService.convertDocxToPdf(tempFile.toString(), convertedFilePath.toString());
//
//            // Upload converted PDF
//            String imageName = generateFileName("converted.pdf");
//            String folderName = "document/";
//            String fullFileName = folderName + imageName;
//
//            BlobId blobId = BlobId.of(BUCKET_NAME, fullFileName);
//            BlobInfo blobInfo = BlobInfo.newBuilder(blobId)
//                    .setMetadata(Map.of("firebaseStorageDownloadTokens", imageName))
//                    .setContentType("application/pdf")
//                    .build();
//            storage.create(blobInfo, Files.newInputStream(convertedFilePath));
//            String fileUrl = getDownloadUrl(blobInfo);
//
//            Category category = categoryService.getCategoryById(idCategory);
//            GeneralDocument document = new GeneralDocument();
