...
public class CategoryController {
    ...
    @GetMapping("/categories_parent_id2")
    public List<Category> getCategoriesByParentId2(@RequestParam int parentId) {
        return categoryService.getCategoriesByParentId2(parentId);
    }
